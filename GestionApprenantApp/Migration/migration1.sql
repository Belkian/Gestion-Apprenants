...
CREATE TABLE GestionApp_COURS(
	...
	,CONSTRAINT GestionApp_COURS_CLASSE_FK FOREIGN KEY (ID_CLASSE) REFERENCES GestionApp_CLASSE(ID_CLASSE)
)ENGINE=InnoDB;
...
CREATE TABLE GestionApp_USERHASCLASSE(
        ID_CLASSE Int NOT NULL ,
        ID_USER  Int NOT NULL
	,CONSTRAINT GestionApp_USERHASCLASSE_PK PRIMARY KEY (ID_CLASSE,ID_USER)

	,CONSTRAINT GestionApp_USERHASCLASSE_CLASSE_FK FOREIGN KEY (ID_CLASSE) REFERENCES GestionApp_CLASSE(ID_CLASSE)
